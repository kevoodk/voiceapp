...
<form style="width:500px; margin:0 auto;">
  <input style="width:100%;"type="text" id="contact-name" name="contact-name" placeholder="Insert you name"/>
  <input style="width:100%;" type="email" id="contact-email" name="contact-email" placeholder="Insert your email"/>
